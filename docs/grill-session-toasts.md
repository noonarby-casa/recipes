...
- **Details:**
  ...
  - Avoids collisions with the bottom-left floating timer FAB / Cooking Dashboard overlay ([`OverlayPanel.svelte`](../themes/cookpot/assets/js/components/primitives/OverlayPanel.svelte)).
...
- **Details:**
  - Add `<div id="toast-container-mount"></div>` to [`baseof.html`](../themes/cookpot/layouts/baseof.html).
  - Register `ToastContainer` in [`svelte-main.ts`](../themes/cookpot/assets/js/svelte-main.ts) alongside `OverlayPanel` and `SettingsModal`.
