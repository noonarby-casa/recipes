...
2. Meanwhile, in a medium bowl, mix the mayonnaise ({{< qty "1/2 cup" >}}), sour cream ({{< qty "1/2 cup" >}}), tequila ({{< qty "1 1/2 tablespoons" >}}), lime juice ({{< qty "4 tablespoons" >}}), garlic ({{< qty "2 medium cloves" >}}), cilantro ({{< qty "1/3 cup" >}}), remaining sugar ({{< qty "1 teaspoon" >}}), and salt ({{< qty "1 teaspoon" >}}), then cover and refrigerate.
